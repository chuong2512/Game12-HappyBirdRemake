...
public class IAPKey
{
    public const string PACK1 = "fappi_bird_1";
    public const string PACK2 = "fappi_bird_2";
    public const string PACK3 = "fappi_bird_3";
    public const string PACK4 = "fappi_bird_4";
}
